...
import {
  ...
  SolanaFluxbeamUpdateV1TokenMetadataTool,
  SolanaFluxbeamUpdateV2TokenMetadataTool,
...
export function createSolanaTools(solanaKit: SolanaAgentKit) {
  return [
    ...
    new SolanaFluxbeamUpdateV1TokenMetadataTool(solanaKit),
    new SolanaFluxbeamUpdateV2TokenMetadataTool(solanaKit),
